  ...
  return (
    <div style={{ minHeight: "100vh", background: "radial-gradient(ellipse at 50% -10%, #241c5e 0%, #151038 45%, #0d0a26 100%)", color: "#C9CCE8", fontFamily: "'Spectral', Georgia, serif", position: "relative", overflowX: "hidden" }}>
      <style>{`
        ...
        .cal::-webkit-scrollbar{ height:6px } .cal::-webkit-scrollbar-thumb{ background:#3A3470; border-radius:3px }
      `}</style>
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "30px 16px 60px", position: "relative" }}>
        {/* language switcher */}
